...
assert checkpass(111111)
assert not checkpass(223450)
assert not checkpass(123789)
assert checkpass(112233, True)
assert checkpass(123444)
assert not checkpass(123444, True)
assert checkpass(111122)
assert checkpass(111122, True)

print(sum(checkpass(x) for x in range(231832, 767346 + 1)))
print(sum(checkpass(x, True) for x in range(231832, 767346 + 1)))
