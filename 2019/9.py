...
assert run([104, 1125899906842624, 99]).output == [1125899906842624]
assert run([1102, 34915192, 34915192, 7, 4, 7, 99, 0]).output == [1219070632396864]

if __name__ == "__main__":
    tape = list(vector(Input(9).read()))
    print(Intcode(tape, input=[1]).run())
    print(Intcode(tape, input=[2]).run())
